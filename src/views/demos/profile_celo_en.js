              ...
              <Row>
                ...
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Chaerin Kim</span>
                ...
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Soohyun Yeo</span>
                        <small className="h6 text-muted">Computer Science</small>
                      </h5>
                    </div>
                  </div>
                ...
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Siwon Lee</span>
                        <small className="h6 text-muted">Business Administration</small>
                      </h5>
                    </div>
                  </div>
                </Col>
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Youngbin Park</span>
                ...
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Seungwon Choi</span>
                        <small className="h6 text-muted">Computer Science</small>
                      </h5>
                    </div>
                  </div>
                ...
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Jihwan Han</span>
