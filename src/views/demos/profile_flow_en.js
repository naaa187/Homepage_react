              ...
              <Row>
                ...
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Namhye Kim</span>
                        <small className="h6 text-muted">International Studies</small>
                      </h5>
                    </div>
                  </div>
                </Col>
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Yewon Bahn</span>
                ...
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Hyunsun Yoo</span>
                ...
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Juyeon Lee</span>
                        <small className="h6 text-muted">Mechanical Biomedical Engineering</small>
                      </h5>
                    </div>
                  </div>
                </Col>
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Kihun Yun</span>
                        <small className="h6 text-muted">Sociology</small>
                      </h5>
                    </div>
                  </div>
                </Col>
                <Col className="mb-5 mb-lg-0" lg="3" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title">
                        <span className="d-block mb-1">Suhyun Lee</span>
                        <small className="h6 text-muted">Computer Science</small>
                      </h5>
                    </div>
                  </div>
                </Col>
